...
// const splitNames = people.map((split) =>{
//     return split.split(',');
// });

// // console.log('names split', splitNames);

// // firstLast = splitNames.sort((a,b) => {
...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce(function(total, inventor ) {
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce(function(total, travelMethod) {
    if (total[travelMethod]){
        total[travelMethod]++;
    } else {
        total[travelMethod]=1;
    }
    return total;
}, {});
